...
_This is Part 1 of an ongoing series about building [Gomi Bunrui](https://gomi-bunrui.app/app/), an AI-powered waste classification app for Japan, using AI tools at every layer of the stack._

---

>Originally published on [Substack](https://open.substack.com/pub/georgeracu/p/i-used-8-ai-tools-to-build-and-ship?r=3cnvlt&utm_campaign=post&utm_medium=web&showWelcomeOnShare=true)
